...
<div class="antialiased bg-gray-100 dark-mode:bg-gray-900">
        <div class="w-full text-gray-700 bg-white dark-mode:text-gray-200 dark-mode:bg-gray-800">
            ...
            <div class="flex flex-row items-center justify-between p-4">
                <a href="<?php echo get_home_url(); ?>" class="text-lg font-semibold tracking-widest text-gray-900 uppercase rounded-lg dark-mode:text-white focus:outline-none focus:shadow-outline">
                    <?php the_custom_logo(); ?>
                </a>
            ...
            <nav :class="{'flex': open, 'hidden': !open}" class="main-navigation flex-col flex-grow hidden pb-4 md:pb-0 md:flex md:justify-end md:flex-row md:items-center">
                <?php
                    $args = [
                ...
                <div @click.away="open = false" class="relative" style="z-index: 10;" x-data="{ open: false }">
